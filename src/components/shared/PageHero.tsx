...
export function PageHero({ eyebrow, title, subtitle, intro }: PageHeroProps) {
  return (
    <section className="flex min-h-screen flex-col justify-center px-4 py-28 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-12 shadow-premium sm:px-10 lg:px-14 lg:py-16">
          <div className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,var(--color-primary),var(--color-accent),transparent)] opacity-70" />
