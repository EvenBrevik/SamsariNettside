...
type ProductItem = { title: string; description: string; highlights: string[]; url?: string; badge?: string };
...
type SharedLocaleContent = {
  ...
  common: {
    bookMeeting: string; exploreMore: string; trustedBy: string; readArticle: string; viewAllArticles: string;
    viewAllServices: string; viewAllProducts: string; viewAllCases: string;
    talkToUs: string; results: string; challenge: string; solution: string; value: string; categoryAll: string; sendMessage: string;
...
export const siteContent: Record<Language, SharedLocaleContent> = {
  no: {
    nav: { home: 'Hjem', services: 'Tjenester', products: 'Produkter', cases: 'Kundecase', blog: 'Blogg', about: 'Om oss', contact: 'Kontakt' },
    common: {
      bookMeeting: 'Book gratis kartleggingsmøte', exploreMore: 'Se hva vi kan gjøre for deg', trustedBy: 'Stolt på av ledende firma',
      readArticle: 'Les artikkel', viewAllArticles: 'Se alle artikler',
      viewAllServices: 'Se alle tjenester', viewAllProducts: 'Se alle produkter', viewAllCases: 'Se alle kundecase',
      talkToUs: 'Snakk med oss', results: 'Resultat', challenge: 'Problem',
      ...
      categoryLabels: { 'Power Platform': 'Power Platform', 'AI': 'AI', 'Microsoft 365': 'Microsoft 365', 'Automatisering': 'Automatisering' },
    },
    home: {
      hero: {
      ...
      casesPreview: { title: 'Kundecase som merkes i driften', subtitle: 'Resultater med fokus på spart tid, bedre kontroll og høyere gjennomføringsevne.' },
    ...
    casesPage: { title: 'Kundecase som viser hvordan moderne arbeidsflyt skaper fart', subtitle: 'Eksempler på hvordan Samsari forenkler prosesser, samler informasjon og skaper tydelige gevinster.', intro: 'Reelle resultater oppstår når teknologi møter riktig prosessforståelse. Derfor beskriver vi alltid både utfordringen, løsningen og den målbare effekten.' },
    ...
    services: [
      ...
      { title: 'React-applikasjoner', summary: 'Vi bygger skreddersydde webapplikasjoner med React og TypeScript for virksomheter som trenger mer fleksibilitet enn standardverktøy kan gi.', problem: 'Mange virksomheter har behov som ikke passer inn i Power Apps eller eksisterende systemer, og ender opp med løsninger som er vanskelige å tilpasse og vedlikeholde.', value: 'En moderne, skalerbar applikasjon bygget spesifikt rundt prosessene og dataene dere jobber med, uten begrensningene i et standardprodukt.' },
    ],
    products: [
      { title: 'Prosjektportalen', description: 'En komplett prosjektportal for Microsoft 365 som samler oppgaver, dokumenter, fremdrift og ansvar på ett sted. Designet for prosjektmiljøer som vil ha ryddig prosjektstyring uten kompleks implementering.', highlights: ['Prosjektoversikt og fremdriftsstyring', 'Dokumentflyt og godkjenningsprosesser', 'Rollbasert tilgang og ansvar', 'Bygget på Microsoft 365'], url: 'https://app.samsari.no/', badge: 'Produktisert løsning' },
      { title: 'Forge Engine', description: 'Kundene dine laster opp CAD-filer og får prisestimat i sanntid – direkte fra din nettside. Du får full kontroll over priser, materialer og maskiner. Norskutviklet SaaS for produksjonsbedrifter.', highlights: ['Automatisk priskalkulator basert på CAD-geometri', 'Full kontroll over materialer, tykkelser og maskinoppsett', 'Dashboard med alle forespørsler og prisdetaljer', 'Støtter DXF og STEP – klart på 1 dag'], url: 'https://forgeengine.no/', badge: 'SaaS · Priskalkulator' },
      { title: 'Skreddersydde applikasjoner', description: 'Når ingen standard løsning passer godt nok, bygger vi tilpassede applikasjoner fra bunnen av. Vi leverer moderne webapper, Power Apps og systemer som passer akkurat din virksomhet.', highlights: ['Moderne webapper med React', 'Power Apps og Power Automate', 'Integrert med eksisterende systemer', 'Designet for faktisk bruk'], badge: 'Custom development' },
    ],
    cases: [
  ...
  en: {
    nav: { home: 'Home', services: 'Services', products: 'Products', cases: 'Customer cases', blog: 'Blog', about: 'About', contact: 'Contact' },
    common: {
      bookMeeting: 'Book free discovery call', exploreMore: 'See what we can do for you', trustedBy: 'Trusted by leading companies',
      readArticle: 'Read article', viewAllArticles: 'View all articles',
      viewAllServices: 'View all services', viewAllProducts: 'View all products', viewAllCases: 'View all customer cases',
      talkToUs: 'Talk to us', results: 'Result', challenge: 'Problem',
      ...
      categoryLabels: { 'Power Platform': 'Power Platform', 'AI': 'AI', 'Microsoft 365': 'Microsoft 365', 'Automatisering': 'Automation' },
    },
    home: {
      hero: {
      ...
      casesPreview: { title: 'Customer cases felt in daily operations', subtitle: 'Results focused on time saved, stronger control and better execution.' },
      ...
      finalCta: { title: 'Ready to work smarter?', description: 'Let us identify where you can reduce manual work and create more flow with the tools you already have.', primaryCta: 'Book meeting' },
    },
    ...
    casesPage: { title: 'Customer cases showing how modern workflow creates momentum', subtitle: 'Examples of how Samsari simplifies processes, connects information and creates visible gains.', intro: 'Real results emerge when technology meets the right process understanding. That is why we always describe the challenge, the solution and the measurable impact.' },
    ...
    services: [
      ...
      { title: 'React applications', summary: 'We build custom web applications with React and TypeScript for businesses that need more flexibility than standard tools can offer.', problem: 'Many businesses have needs that do not fit Power Apps or existing systems, and end up with solutions that are hard to adapt and maintain.', value: 'A modern, scalable application built specifically around your processes and data, without the limitations of a standard product.' },
    ],
    products: [
      { title: 'Project Portal', description: 'A complete project portal for Microsoft 365 that brings together tasks, documents, progress and ownership in one place. Designed for project environments that want clean governance without complex implementation.', highlights: ['Project overview and progress tracking', 'Document flow and approval processes', 'Role-based access and ownership', 'Built on Microsoft 365'], url: 'https://app.samsari.no/', badge: 'Productized solution' },
      { title: 'Forge Engine', description: 'Your customers upload CAD files and get price estimates in real time — directly from your website. You get full control over prices, materials and machines. Norwegian-developed SaaS for manufacturing companies.', highlights: ['Automatic price calculator based on CAD geometry', 'Full control over materials, thicknesses and machine setup', 'Dashboard with all requests and price details', 'Supports DXF and STEP — ready in 1 day'], url: 'https://forgeengine.no/', badge: 'SaaS · Price calculator' },
      { title: 'Custom applications', description: 'When no standard solution fits well enough, we build tailored applications from scratch. We deliver modern web apps, Power Apps and systems designed specifically for your business.', highlights: ['Modern web apps with React', 'Power Apps and Power Automate', 'Integrated with existing systems', 'Designed for real-world use'], badge: 'Custom development' },
    ],
    cases: [
